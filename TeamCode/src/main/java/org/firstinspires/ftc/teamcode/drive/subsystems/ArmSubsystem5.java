...
public class ArmSubsystem5 {
    ...
    public ArmSubsystem5(HardwareMap hardwareMap) {
        this(hardwareMap, null);
    }

    public ArmSubsystem5(HardwareMap hardwareMap, @Nullable LinearOpMode linearOpMode) {
        opMode = linearOpMode;
        // Initialize the virtual four bar
        v4B = new V4BSubsystem2(hardwareMap);
...
//                if (!ltReader.isDown() && !boxSwitch.isPressed()) {
    ...
    public double getRightBarPosition() { return v4B.rightVirtualBar.getPosition(); }
    public double getLeftBarPosition() { return v4B.leftVirtualBar.getPosition(); }
